...
#Uncomment for ischemic square region on the Right Atrium#for x in range(25,50):
...
with open("../outputs/ecg_data_healthy.csv", 'w', newline='') as file: #Change output file name
